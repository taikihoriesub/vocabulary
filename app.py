...
def setup_session():
    if st.session_state['data_loaded']:
        ...
        test_types = ['English to Japanese (Multiple Choice)', 'Japanese to English (Multiple Choice)', 
                      'English to Japanese (Descriptive)', 'Japanese to English (Descriptive)']
    ...
    if st.session_state['test_index'] < len(st.session_state['test_questions']):
        ...
        if 'Multiple Choice' in st.session_state['test_type']:
            if st.session_state['test_index'] not in st.session_state['user_choices']:
                other_choices = [row['Japanese' if 'English to' in st.session_state['test_type'] else 'English'] 
